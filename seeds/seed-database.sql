...
SELECT setval('table_id_seq', (SELECT MAX(id) from "users"));
SELECT setval('table_id_seq', (SELECT MAX(id) from "recipes"));
SELECT setval('table_id_seq', (SELECT MAX(id) from "ingredients"));
